				...
				<!-- STEP 4 -->
					...
					<div class="main-content">
						...
						<div class="field">
							...
							<input id="Site Title" name="char_db_name" size="20" type="text" class="medium" value="character0" />
						...
						<div class="field">
							...
							<input id="Site Title" name="w_db_name" size="20" type="text" class="medium" value="mangos0" />
